...
!(function () {
  ...
  (t = window),
    ...
    (t.SimpleJekyllSearch = function (t) {
      var n;
      0 < w.validate(t).length && S("You must specify the following required options: " + v),
        (m = h.merge(m, t)),
        i.setOptions({ template: m.searchResultTemplate, middleware: m.templateMiddleware }),
        u.setOptions({ fuzzy: m.fuzzy, limit: m.limit, sort: m.sortMiddleware }),
        h.isJSON(m.json)
          ? y(m.json)
          : ((n = m.json),
